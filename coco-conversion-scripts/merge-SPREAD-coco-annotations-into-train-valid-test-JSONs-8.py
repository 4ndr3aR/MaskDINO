...
def main(base_dir, output_dir):
    ...
    save_coco_annotations(train_set, os.path.join(output_dir, 'train_annotations-8.json'))
    save_coco_annotations(valid_set, os.path.join(output_dir, 'valid_annotations-8.json'))
    save_coco_annotations(test_set , os.path.join(output_dir, 'test_annotations-8.json'))
